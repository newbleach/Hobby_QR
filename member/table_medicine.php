...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลรายละเอียดยา หรือ อาหารเสริม ที่กินเป็นประจำ</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลรายละเอียดยา หรือ อาหารเสริม ที่กินเป็นประจำ</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
$(document).ready(function() {
    $('a[href^="./table_medicine.php"]').addClass('nav-item has-treeview menu-open nav-link active ');
});
</script>