            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ตารางข้อมูลสุขภาพทั่วไป</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <table  id='example1' class='table table-bordered table-striped projects'>
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>aaaaaaaaaaaaaaaadddddddddasfasfafasfasfasfasfasfa</td>
...
$(document).ready(function() {
    $('a[href^="./table_health_note.php"]').addClass('nav-item has-treeview menu-open nav-link active ');
});
</script>