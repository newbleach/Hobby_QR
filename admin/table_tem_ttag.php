...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">ตารางข้อมูลนามบัตรต้นไม้</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#" style="color:green">หน้าแรก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลนามบัตรต้นไม้</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                      <table  id='example1' class='table table-bordered table-striped projects'>
                                   ...
                                   <tr>
                                            <td>1</td>
                                            <td>TP_TT0001</td>
                                            <td><img src="../images/feedback/plant1.jpg" alt="" width="250px"></td>
                                            <td><img src="../images/feedback/plant1.jpg" alt="" width="250px"></td>
                                            <td>tree name</td>
                                            <td>250</td>
                                    ...
                                    <tr>
                                            <td>2</td>
                                            <td>TP_TT0002</td>
                                            <td><img src="../images/feedback/plant2.jpg" alt="" width="250px"></td>
                                            <td><img src="../images/feedback/plant2.jpg" alt="" width="250px"></td>
                                            <td>tree name</td>
                                            <td>250</td>
                                            <td class='project-actions text-center'>
                                    ...
                                    <tr>
                                            <td>3</td>
                                            <td>TP_TT0003</td>
                                            <td><img src="../images/feedback/plant3.jpg" alt="" width="250px"></td>
                                            <td><img src="../images/feedback/plant3.jpg" alt="" width="250px"></td>
                                            <td>tree name</td>
                                            <td>250</td>
                                            <td class='project-actions text-center'>
