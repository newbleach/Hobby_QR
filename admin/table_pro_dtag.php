                    ...
                    <div class="card-body">
                      <table  id='example1' class='table table-bordered table-striped projects'>
                                   ...
                                   <tr>
                                            <td>1</td>
                                            <td>PD_DT0001</td>
                                            <td><img src="../images/gallery-7.jpg" alt="" width="250px"></td>
                                            <td>mini dog collar</td>
                                            <td>250</td>
                                    ...
                                    <tr>
                                            <td>2</td>
                                            <td>PD_DT0002</td>
                                            <td><img src="../images/gallery-5.jpg" alt="" width="250px"></td>
                                            <td>mini dog collar</td>
                                            <td>250</td>
                                            <td class='project-actions text-center'>
                                            <a href='read_board.php?ID=$row[0]' class='btn btn-primary btn-sm'> <i class='fas fa-eye'>
                                    ...
                                    <tr>
                                            <td>3</td>
                                            <td>PD_DT0003</td>
                                            <td><img src="../images/gallery-6.jpg" alt="" width="250px"></td>
                                            <td>mini dog collar</td>
                                            <td>250</td>
                                            <td class='project-actions text-center'>
                                            <a href='read_board.php?ID=$row[0]' class='btn btn-primary btn-sm'> <i class='fas fa-eye'>
